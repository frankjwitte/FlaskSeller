...
function F:CreateUI()
    ...
    panel.modeButton = button(190, -10, 70, 24, "Lowest", function() F:ToggleScanMode() end)
    panel.closeButton = button(268, -10, 26, 24, "x", function() panel:Hide() end)
...
function F:UpdateUI()
    ...
    p.modeButton:SetText(self.db.lowestPageOnly and "Lowest" or "All pages")
